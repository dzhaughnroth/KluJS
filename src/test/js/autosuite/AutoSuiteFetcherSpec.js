...
define( [ "autosuite/AutoSuiteFetcher", "ConfigFacade"], function( Fetcher, ConfigFacade ) {
    ...
    describe( "AutoSuiteFetcher", function() {
        ...
        var topic = new Fetcher( mock, "src/test/js/autosuite/mockResult.json");
        var recd = 0,
            errs = 0;
        ...
        it( "Does nothing but callsback if autoSuites is falsy", function() {
            var nonconfig = new ConfigFacade({ autoSuites : false });
        ...
        it( "Handles errors", function() {
            var altTopic = new Fetcher( mock, "src/test/js/autosuite/mockErrorResult.json" );
            runs( function() {
