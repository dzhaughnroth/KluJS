/** This is not JQuery. Of course it is, except search KluJS for differences */

// KluJS First This is just an AMD module
define( [], function() {
...
// KluJS: Added the "false" to disable this section
// If left enbaled, KluJS specs do not run with phantom because 
// someone injects unsettable properties "-1", "-3", and "-6"
// However, they do work if you use require-jquery.js.
// And they do work in browsers. Go figure.
...
// KluLS: include dataTables plugin in this file.
/*
...
// KluJS: end of the AMD define function; returns jquery with datatables plugin


var result = $.noConflict(true);
return result;
} );
