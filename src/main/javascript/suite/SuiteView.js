...
define( [ "../lib/notBackbone", "../lib/notUnderscore", "../notJQuery", "./SuiteAssembly", "../lint/LintCollectionView", "../coverage/CoverageDataView", "../jasmine/JasmineView", "../SuiteName", "../FocusFilterFactory", "../goals/SuiteInterpreter" ], function( Backbone, _, $, SuiteAssembly, LintCollectionView, CoverageDataView, JasmineView, SuiteName, FocusFilterFactory, SuiteInterpreter ) {
